...
ARG NEXT_PUBLIC_SITE_URL=https://matu.aitomate.cloud
...
# Re-declare ARGs so server-side code (middleware, API routes) can read
# NEXT_PUBLIC vars at runtime. These are public values — safe to bake in.
ARG NEXT_PUBLIC_SUPABASE_URL=https://placeholder.supabase.co
ARG NEXT_PUBLIC_SUPABASE_ANON_KEY=placeholder
ARG NEXT_PUBLIC_SITE_URL=https://matu.aitomate.cloud
ENV NEXT_PUBLIC_SUPABASE_URL=$NEXT_PUBLIC_SUPABASE_URL
