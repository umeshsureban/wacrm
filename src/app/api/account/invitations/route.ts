...
//   on the list falls through to the matu.aitomate.cloud fallback
...
// (the upstream project's docs/marketing site, a different repo).
// Forks that didn't set `NEXT_PUBLIC_SITE_URL` got invite links
// pointing at someone else's marketing site, which 404s on
...
function getBaseUrl(request: Request): string {
  ...
  return "https://matu.aitomate.cloud";
}
